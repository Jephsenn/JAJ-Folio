...
export default function ExperienceCard( props: Props ) {
    return (
      <a href={props.link==="#"?"javascript:void(0)":props.link} target={props.link==="#"?"_self":"_blank"} className="group m-4 md:w-1/4 h-44 md:h-52 relative bg-white">
        ...
        <div className="opacity-0 absolute ease-in-out duration-300 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 group-hover:opacity-100">
            ...
            {props.link==="#"?<p className="text-red text-lg">No Longer Live</p>:""}
        </div>
      </a>
    )
  }