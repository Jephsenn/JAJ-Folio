  ...
  return (
    <Layout page="home">
      <main className="flex flex-col justify-center">
        <section className="flex items-center flex-col h-screen relative bg-[url('../../public/images/webdev.jpg')] bg-fixed bg-cover bg-center bg-no-repeat before:bg-black/25 before:absolute before:top-0 before:right-0 before:bottom-0 before:left-0 md:bg-scroll">
          ...
          <div className="flex flex-col font-inter z-10">
            <h1 className="my-6 lg:my-6 mx-auto text-white md:text-3xl lg:text-3xl font-bold">John A. Josephsen</h1>
